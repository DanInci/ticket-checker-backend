...
object AnomalyIDs {
  ...
  case object AccountNotVerifiedAnomalyID       extends AnomalyID { override val name: String = "UA_NOT_VERIFIED" }
  case object VerificationCodeNotValidAnomalyID extends AnomalyID { override val name: String = "UA_CODE_NOT_VALID" }
  ...
  case object OrganizationMemberChangesNotAllowedID extends AnomalyID { override val name: String = "ORG_IIA_08" }
  case object OrganizationMemberRoleNotAllowedID    extends AnomalyID { override val name: String = "ORG_IIA_09" }
